...
<div class="container">
	...
	<div class="row">		
		...
		<div class="col-9 pt-3">
			<h3>자료실 - <small>Model2 방식의 Servlet게시판</small></h3>
			...
			<div class="row mt-3">
				...
				<tbody>
<!--
ListCtrl 서블릿에서 request영역에 저장한 ResultSet을 JSTL과 EL을 통해 화면에'
내용을 출력한다.
	choose
		when -> lists 컬렉션에 아무값도 없을때
		otherwise -> ResultSet 결과가 있을때 (출력할 레코드가 있을때)
-->
				<c:choose>
