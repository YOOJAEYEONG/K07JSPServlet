...
<body>
	...
	<table border="1">
  		<tr>
			...
			<%-- 
			input태그의 tabindex속성
				:포커스 이동을 위해 탭(Tab)키를 눌럿을때 포커스가 이동하는 순서를 지정한다.
			...
			--%>
				...
				<%-- 변수user에 저장된 값이 있을때 checkbox의 checked속성을 활성화 --%>
	...
	%>
		<table border=1 width=400>
			<tr>
				<td align="center">
					<%-- 세션영역에 저장된 속성이 있으므로 getArrtibute로 읽어올 수 있다. --%>
