...
public class WriteCtrl extends HttpServlet{
	...
	/*
	글쓰기 페이지의 경우
	doGet()은 글쓰기 폼으로 이동(location)할때의 요청을 처리하고
	doPost()는 글쓰기를 완료(submit)할때의 요청을 처리한다.
	*/
	...
	*/
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		//해당 메소드는 MultimartRequest 객체를 생성하면서 파일업로드를 처리한다.
		/*
		...
		if(mr != null) {
			...
			enctype이 'multipart/form-data' 로 설정되므로 request객체를 통해 폼값을
			받을 수 있다.
			*/
